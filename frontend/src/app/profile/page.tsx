...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-black text-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <span className="font-semibold text-gray-200">mini_notion</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="lg:flex lg:gap-8">
              ...
              <nav className="mt-8">
                <ul className="space-y-2">
                  <li>
                    <a
                      href="#profile"
                      className="block px-3 py-2 rounded-md text-sm bg-white/80"
                    >
                      Профиль
                    </a>
                  </li>
          ...
          <div className="lg:w-3/4">
            {error && (
              <div className="mb-6 p-4 rounded-md bg-gray-900/50 border border-gray-800">
              ...
              <div className="bg-gray-900/70 border border-gray-800 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">{user?.first_name}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">{user?.last_name}</p>
                  </div>
              ...
              <div className="bg-gray-900/70 border border-gray-800 rounded-xl p-6">
                ...
                {subscriptions.length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-gray-400">У вас нет активных подписок</p>
                    <button 
                      className="mt-4 px-4 py-2 bg-white hover:bg-gray-100 rounded-md text-sm"
            ...
            <section id="workspaces" className="mb-8">
              <div className="bg-gray-900/70 border border-gray-800 rounded-xl p-6">
                ...
                {workspaces.length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-gray-400">У вас нет воркспейсов</p>
                    <button className="mt-4 px-4 py-2 bg-gray-600 hover:bg-gray-600 rounded-md text-sm">
                      Создать воркспейс
                    </button>
                  </div>
                ) : (
                    ...
                    {workspaces.map((workspace) => (
                      ...
                      >
                        ...
                        <div className="mt-3 flex justify-end">
                          <button className="text-xs px-3 py-1 rounded-md bg-white hover:bg-gray-100">
                            Открыть
                          </button>
                        </div>
                      </div>
